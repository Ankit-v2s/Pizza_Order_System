...
<body>
		...
		<div class="container">
			...
			<div class="main-body table-wrapper-scroll-y my-custom-scrollbar">
				<table class="table table-hover table-light	">
					...
					<tr>
						<td colspan="2">
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#customerEdit">
	...
	<div class="modal fade-in" id="customerEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="state" disabled="disabled" value="${customer.state}" name="state">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="country" disabled="disabled" value="${customer.country}" name="country">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="phoneNumber" value="${customer.phoneNumber}" name="phoneNumber">
							<div id="phoneError" class="error"></div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal"><spring:message code="customer.details.modal.update.button.close.label" /></button>
					<button type="button" class="btn btn-primary" id="updateCustomer"><spring:message code="customer.details.modal.update.button.submit.label" /></button>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript" src="<c:url value="/static/js/customer-details.js" />"></script>
</body>
</html>